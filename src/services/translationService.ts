...
const translations: LanguageTranslations = {
  Portuguese: {
    ...
    'backup.created.successfully': 'O backup do banco de dados foi criado e salvo com sucesso',
    'database.deleted': 'Banco de Dados Excluído',
    'database.deleted.permanently': 'O banco de dados completo foi excluído permanentemente',
    'language.changed': 'Idioma Alterado',
    'interface.language.changed': 'O idioma da interface foi alterado para',
