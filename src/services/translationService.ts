...
const translations: LanguageTranslations = {
  Portuguese: {
    ...
    // Modal Components
    'view.network': 'Ver Rede',
    'edit.user.info': 'Editar Informações do Usuário',
    'block.user': 'Bloquear Usuário',
    'unblock.user': 'Desbloquear Usuário',
    'delete.user': 'Excluir Usuário',
    'change.password.for': 'Alterar Senha para',
    'set.a.new.password.for.this.user.account': 'Definir uma nova senha para esta conta de usuário',
    'update.the.users.personal.information.and.settings': 'Atualizar as informações pessoais e configurações do usuário',
    'note': 'Nota',
    'the.user.will.need.to.use.this.new.password.for.their.next.login': 'O usuário precisará usar esta nova senha para seu próximo login',
    'enter.new.password': 'Digite a nova senha',
    'update.user': 'Atualizar Usuário',
    'user.details': 'Detalhes do Usuário',
    'view.detailed.information.about': 'Ver informações detalhadas sobre',
    ...
    'create.a.new.sales.transaction': 'Criar uma nova transação de venda',
    'enter.customer.name': 'Digite o nome do cliente',
    'enter.store.location': 'Digite a localização da loja',
    ...
    'view.detailed.information.about.sale': 'Ver informações detalhadas sobre a venda',
    'close': 'Fechar',
    'add.new.store': 'Adicionar Nova Loja',
    'add.a.new.store.location.to.the.system.with.complete.information': 'Adicionar uma nova localização de loja ao sistema com informações completas',
    'enter.store.name': 'Digite o nome da loja',
    'enter.city.name': 'Digite o nome da cidade',
    'enter.street.address': 'Digite o endereço da rua',
    'enter.state': 'Digite o estado',
    'enter.store.number.numbers.only': 'Digite o número da loja (apenas números)',
    'manager.name': 'Nome do Gerente',
    'add.store': 'Adicionar Loja',
    
    // Additional Missing Keys
    'reports.and.analytics': 'Relatórios e Análises',
    'comprehensive.insights.into.your.loyalty.program.performance': 'Insights abrangentes sobre o desempenho do seu programa de fidelidade',
  ...
  English: {
    ...
    'set.a.new.password.for.this.user.account': 'Set a new password for this user account.',
    'update.the.users.personal.information.and.settings': 'Update the user\'s personal information and settings.',
    'note': 'Note',
    'the.user.will.need.to.use.this.new.password.for.their.next.login': 'The user will need to use this new password for their next login.',
    ...
    'create.a.new.sales.transaction': 'Create a new sales transaction',
    'enter.customer.name': 'Enter customer name',
    'enter.store.location': 'Enter store location',
    ...
    'view.detailed.information.about.sale': 'View detailed information about sale',
    'close': 'Close',
    'add.new.store': 'Add New Store',
    'add.a.new.store.location.to.the.system.with.complete.information': 'Add a new store location to the system with complete information.',
    ...
    'enter.store.number.numbers.only': 'Enter store number (numbers only)',
  ...
  Spanish: {
    ...
    'set.a.new.password.for.this.user.account': 'Establecer una nueva contraseña para esta cuenta de usuario.',
    'update.the.users.personal.information.and.settings': 'Actualizar la información personal y configuración del usuario.',
    'note': 'Nota',
    'the.user.will.need.to.use.this.new.password.for.their.next.login': 'El usuario necesitará usar esta nueva contraseña para su próximo inicio de sesión.',
    'enter.new.password': 'Ingrese nueva contraseña',
    'update.user': 'Actualizar Usuario',
    'user.details': 'Detalles de Usuario',
    'view.detailed.information.about': 'Ver información detallada sobre',
    ...
    'create.a.new.sales.transaction': 'Crear una nueva transacción de venta',
    'enter.customer.name': 'Ingrese nombre del cliente',
    'enter.store.location': 'Ingrese ubicación de la tienda',
    ...
    'view.detailed.information.about.sale': 'Ver información detallada sobre la venta',
    'close': 'Cerrar',
    'add.new.store': 'Agregar Nueva Tienda',
    'add.a.new.store.location.to.the.system.with.complete.information': 'Agregar una nueva ubicación de tienda al sistema con información completa.',
    'enter.store.name': 'Ingrese nombre de la tienda',
    'enter.city.name': 'Ingrese nombre de la ciudad',
    'enter.street.address': 'Ingrese dirección de la calle',
    'enter.state': 'Ingrese estado',
    'enter.store.number.numbers.only': 'Ingrese número de tienda (solo números)',
    'manager.name': 'Nombre del Gerente',
    'add.store': 'Agregar Tienda',
    
    // Additional Missing Keys
    'reports.and.analytics': 'Informes y Análisis',
    'comprehensive.insights.into.your.loyalty.program.performance': 'Insights integrales sobre el rendimiento de tu programa de fidelidad',
  ...
  French: {
    ...
    'change.password.for': 'Changer le Mot de Passe pour',
    'set.a.new.password.for.this.user.account': 'Définir un nouveau mot de passe pour ce compte utilisateur.',
    'update.the.users.personal.information.and.settings': 'Mettre à jour les informations personnelles et paramètres de l\'utilisateur.',
    'note': 'Note',
    'the.user.will.need.to.use.this.new.password.for.their.next.login': 'L\'utilisateur devra utiliser ce nouveau mot de passe pour sa prochaine connexion.',
    ...
    'view.detailed.information.about': 'Voir les informations détaillées sur',
    'enter.phone.number': 'Entrez le numéro de téléphone',
    'enter.email.address': 'Entrez l\'adresse email',
    'phone': 'Téléphone',
    'email': 'Email',
    'full.name': 'Nom Complet',
    'add.new.sale': 'Ajouter Nouvelle Vente',
    'create.a.new.sales.transaction': 'Créer une nouvelle transaction de vente',
    'enter.customer.name': 'Entrez le nom du client',
    'enter.store.location': 'Entrez l\'emplacement du magasin',
    ...
    'view.detailed.information.about.sale': 'Voir les informations détaillées sur la vente',
    'close': 'Fermer',
    'add.new.store': 'Ajouter Nouveau Magasin',
    'add.a.new.store.location.to.the.system.with.complete.information': 'Ajouter un nouvel emplacement de magasin au système avec des informations complètes.',
    ...
    'enter.store.number.numbers.only': 'Entrez le numéro du magasin (chiffres uniquement)',
    'manager.name': 'Nom du Gestionnaire',
    'add.store': 'Ajouter Magasin',
