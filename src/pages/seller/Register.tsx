...
import { Droplets, Store, Eye, EyeOff, ArrowLeft } from "lucide-react";
...
const SellerRegister = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      // Validate form data
      if (!formData.name || !formData.email || !formData.password || !formData.phone || !formData.storeNumber) {
        toast({
    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription>Seller Registration</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center space-y-2">
            <div className="text-sm text-muted-foreground">
              ...
              <Link to="/seller/login" className="text-loyalty-gold hover:underline">
                Sign in here
              </Link>
            </div>
            <div className="pt-2">
