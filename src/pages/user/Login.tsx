  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        if (!['user', 'customer'].includes(response.data.user.role)) {
          toast({
            title: "Access Denied",
            description: "Only customers can access the customer portal",
            variant: "destructive",
          });
          return;
        }
        ...
        toast({
          ...
          description: "Welcome to ÁGUA TWEZAH Customer Portal",
        });
